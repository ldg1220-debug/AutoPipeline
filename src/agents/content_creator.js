...
❷ context (3~15초) — 지금 무슨 일이 벌어지고 있는가 (배경 먼저, 수치 나중)
   - 순서 필수: ① 지금 무슨 일이 일어나고 있는지 → ② 왜 그런지 → ③ 그래서 나에게 어떤 영향
   - 수치를 쓸 때 반드시 기준 명시: ✗ "이자 5만원 증가" → ✓ "1억 변동금리 대출 기준 월 이자 5만원 증가"
   - ✗ 맥락 없이 결론 점프 금지: "경기가 나빠지면 해고될 수 있다" 같은 비약 금지
   - 50~80자

❸ insight (15~40초) — 인과관계를 단계별로 설명 (비약 금지)
   - 필수 구조: [원인] → [중간 과정] → [결과] → [내가 할 행동]
   - 예) 경기침체: "기업 매출 감소(원인) → 비용 절감 압박(과정) → 채용 동결·구조조정 가능성(결과) → 비상금 3개월치 확보(행동)"
